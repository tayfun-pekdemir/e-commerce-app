...
export default function PromoSection() {
    return (
        <section className="flex flex-col pt-30 h-250 lg:h-170 md:px-11 md:pt-4 lg:gap-36 lg:flex-row lg:pt-0 md:justify-center md:items-center">
            <div className="flex flex-col flex-1 px-11 items-center gap-8 text-center justify-center md:px-0 lg:order-2 md:items-start lg:text-start">
                ...
                <div className="flex flex-col gap-6 md:gap-8 lg:flex-row">
                    <button className="bg-[#23A6F0] px-10 py-4 rounded-sm text-sm text-white font-bold lg:bg-[#2DC071]">BUY NOW</button>
                    <button className="px-10 py-4 rounded-sm text-sm text-[#23A6F0] border border-[#23A6F0] font-bold lg:border-[#2DC071] lg:text-[#2DC071]">Learn More</button>
                </div>
            </div>
